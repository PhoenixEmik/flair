...
.. code:: sh
   ...
   conda env update --name flair --file https://github.com/BrooksLabUCSC/flair/releases/download/v3.0.1/flair_diffexp_conda_env.yaml
...
.. code:: sh
   ...
   conda env create -n flair --file https://github.com/BrooksLabUCSC/flair/releases/download/v3.0.1/flair_conda_env.yaml
   conda activate flair
...
.. code:: sh
    ...
    docker pull brookslab/flair:3.0.1
    docker run -v [your_path_to_data]:/data brookslab/flair:3.0.1 flair [align/correct/...]
